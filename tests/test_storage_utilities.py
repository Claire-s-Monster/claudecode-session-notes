#!/usr/bin/env python3
"""
Tests for the file-based storage utilities.

This test suite validates the core storage utilities functions
extracted from the server module for testing purposes.
"""
...
# Replicate storage utilities for testing (extracted from server.py)
...
def save_json_data(file_path: Path, data) -> None:
